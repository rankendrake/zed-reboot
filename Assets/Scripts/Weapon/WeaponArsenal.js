...
function initializeArsenal () : Weapon[] {
	...
	*/
	...
	// Revolver
	weapons[1] = new ProjectileWeapon(2, 120, 50, 0, 1, 6, 2, 30, 0.4, 2, 
		"revolver", revolverBulletPrefab, zed, new Vector2(0.81,-0.02), clips[2], clips[3]);
	
	// Shotgun
	weapons[2] = new ProjectileWeapon(1.1, 50, 30, 20, 5, 7, 1, 10, 0.5, 2, 
		"shotgun", shotgunBulletPrefab, zed, new Vector2(0.8,-0.13), clips[4], clips[5]);
	
	// AssaultRifle
	weapons[3] = new ProjectileWeapon(7, 20, 30, 0, 1, 24, 1, 20, 0.1, 2, 
